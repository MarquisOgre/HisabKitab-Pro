      ...
      <div className="flex flex-col gap-3 md:flex-row md:items-center md:justify-between">
        <div className="flex items-center gap-3">
          ...
          <div className="min-w-0">
            <h1 className="text-lg md:text-2xl font-bold truncate">Edit Purchase {invoiceNumber}</h1>
            <p className="text-muted-foreground text-sm hidden md:block">Update invoice details</p>
          </div>
        </div>
        <div className="flex gap-2 w-full md:w-auto">
          <Button variant="outline" onClick={() => navigate(`/purchase/bills/${id}`)} className="flex-1 md:flex-none" size="sm">
            Cancel
          </Button>
